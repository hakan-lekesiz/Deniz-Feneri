...
Feux.Tabber = {
    ...
    Actions: {
        ...
        mfInit: function (arg) {
            ...
            for (ti = 0; ti < tabberContainerEl.tabberHeadItems.length; ti++) {
                var tabberHeadItem = tabberContainerEl.tabberHeadItems[ti];
            ...
            for (var u = 0; u < props.tabberContainerIdArrByUrl.length; u++) {
                var arr = props.tabberContainerIdArrByUrl(u).split(':');
                var tabberContainerId = arr[0];

                // If mf related container id is the same as url contains...
                if (tabberContainerId === arg.tabberContainerId) {
                    var tabNo = arr[1];
            ...
            if (hasQueryString) {
                ...
                setTimeout(function () {
                    for (var u = 0; u < props.tabberContainerIdArrByUrl.length; u++) {
                        ...
                        var tabHeadItemEl_ = tabberContainerEl.querySelector('[data-tab-no="' + tabNo_ + '"]');
