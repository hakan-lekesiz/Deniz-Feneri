    ...
    Scroll: {
        events: function () {
            window.onscroll = function (event) {
                ...
                var dataBodyClass = Feux.Globals.mainElem.getAttribute("class");
                if (Feux.Layout.Map.status.isMapLoaded) {
                    Feux.Layout.Map.closeInfoWindow();
                }
                if (window.pageYOffset > 0) {
                    Feux.Globals.bodyElem.classList.add('f-scrolled');
                    if (dataBodyClass && dataBodyClass.contains('header-transparent')) {
                        Feux.Globals.bodyElem.classList.remove('header-transparent');
                    }
                }
                else {
                    Feux.Globals.bodyElem.classList.remove('f-scrolled');
                    if (dataBodyClass &&
                        dataBodyClass.contains('header-transparent') &&
                        !Feux.Globals.bodyElem.classList.contains("noscroll")) {
                        Feux.Globals.bodyElem.classList.add('header-transparent');
                    }
                }
                ...
                if (!isJsonEmpty(Feux.Animation)) {
                    if (typeof Feux.Animation.scrollEvents === 'function') {
